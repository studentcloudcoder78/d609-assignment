...
DataSourceAccelerometer_node1746057240433 = glueContext.create_dynamic_frame.from_catalog(database="d609", table_name="accelerometer_trusted", transformation_ctx="DataSourceAccelerometer_node1746057240433")
...
'''
SQLQuery_node1746226406598 = sparkSqlQuery(glueContext, query = SqlQuery3687, mapping = {"customer_trusted":DataSourceCustomers_node1745979555851, "accelerometer_trusted":DataSourceAccelerometer_node1746057240433}, transformation_ctx = "SQLQuery_node1746226406598")
